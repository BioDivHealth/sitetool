...
2.  **Populated Sites**
    ...
    Populated sites will find all of the towns/villages/cities in the
    selected area using OpenStreetMap. You can have the tool find all of
    the populated sites in an area or randomly select a subset from that
    region. Note that if you select a very large area for populated sites,
